...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/test-vxe-table-paged/': RouteRecordInfo<
      ...
      | never
    >,
    '/test-vxe-table-paged/infinite-context': RouteRecordInfo<
      '/test-vxe-table-paged/infinite-context',
      '/test-vxe-table-paged/infinite-context',
      Record<never, never>,
      Record<never, never>,
      | never
    >,
    '/test-vxe-table-paged/infinite-pages': RouteRecordInfo<
      '/test-vxe-table-paged/infinite-pages',
      '/test-vxe-table-paged/infinite-pages',
      Record<never, never>,
      Record<never, never>,
      | never
    >,
    '/test-vxe-table-paged/infinite-transform-trick': RouteRecordInfo<
      '/test-vxe-table-paged/infinite-transform-trick',
      '/test-vxe-table-paged/infinite-transform-trick',
      Record<never, never>,
      Record<never, never>,
